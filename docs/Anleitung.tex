...
Diese Manual-Ausgabe beschreibt das Paket im Stand v1.0.4
...
\begin{itemize}\setlength{\itemsep}{0pt}
  ...
  \item \textbf{v1.0.3}: neue Diagnose-Ausgaben -- das
        ...
        zwei zus\"atzliche UMAP-Einbettungen (SS-UMAP und Ca-UMAP)
  ...
  \item \textbf{v1.0.4}: auditgetriebene Korrekturen der
        ...
        N-H-Stretches, SS-Element-Amplituden und SCSD-Amplituden
...
Skalierung, das SS-Element verwendete eine fest verdrahtete Konstante
...
\texttt{hn\_stretch}, SS-Element \texttt{amplitude\_mean},
...
\begin{itemize}\setlength{\itemsep}{2pt}
  ...
  \item \texttt{s\_amplitude\_mean} / \texttt{s\_axial\_amplitude} /
        ...
        \texttt{analyze\_ss\_element}: vor v1.0.4 wurde eine fest
        ...
        SS-Element-Eintr\"age, die unter dem alten Code als
...
und die SS-Element-Bl\"atter. Die Werte sind identisch; nur Sigmas
...
\subsubsection*{\texttt{SS\_UMAP\_clusters} / \texttt{SS\_UMAP\_profile}
                  \emph{(seit v1.0.3)}}
\label{app:wb-embed-ssumap}

Sekund\"arstruktur-UMAP, beschr\"ankt auf Modes, die mindestens einen
nicht-null Eintrag in der pro-SS-Element-Feature-Zeile haben
(\texttt{ss}-Dict nach \texttt{analyze\_all\_ss} nicht leer).
...
ihren SS-UMAP-Koordinaten und HDBSCAN-Cluster-ID; das
\texttt{*\_profile}-Sheet gibt das Z-Score-Profil der
diskriminierenden Top-30-SS-Elemente pro Cluster aus.
...
\begin{itemize}\setlength{\itemsep}{0pt}
  \item \emph{Globales UMAP} (\texttt{Projektionen}): Welche Modes
        ...
        PCET-aktiver Modes.
  \item \emph{SS-UMAP} (\texttt{SS\_UMAP\_*}): Welche Modes haben
...
\texttt{\_embedding\_SS\_UMAP.png} (3 Panele: Frequenz / Mode-Typ /
