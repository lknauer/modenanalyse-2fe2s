...
\date{Software version 1.2.1 \quad\textbar\quad Document compiled \today}
...
\midrule
Package version           & 1.2.1              & SemVer; the audit trail
...
This part documents the test suite. As of v1.2.1 it comprises
177 unit tests + 4 end-to-end (E2E) smoke tests (181 total; the
...
angle-criterion tests) and v1.2.1 (ORCA reduced-mass reconstruction).

% -------------------------------------------------------------------------
\section{Overview: 181 tests}
