...
\date{Software version 1.2.2 \quad\textbar\quad Document compiled \today}
...
\midrule
Package version           & 1.2.2              & SemVer; the audit trail
...
This part documents the test suite. As of v1.2.2 it comprises
191 unit tests + 4 end-to-end (E2E) smoke tests (195 total; the
...
and v1.2.2 (interpolation grid range).

% -------------------------------------------------------------------------
\section{Overview: 195 tests}
